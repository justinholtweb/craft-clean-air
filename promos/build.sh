...
# Output: promos/out/cleanair-promo-N.jpg at 1920x1080 (rendered at 2x, downsampled).
...
for n in $SLIDES; do
  "$CHROME" \
    ...
    --screenshot="out/cleanair-promo-$n.png" \
  ...
  sips --resampleWidth 1920 -s format jpeg -s formatOptions 90 \
    "out/cleanair-promo-$n.png" --out "out/cleanair-promo-$n.jpg" >/dev/null
  rm "out/cleanair-promo-$n.png"
  echo "  built out/cleanair-promo-$n.jpg"
done
